...
import com.sporniket.libre.memoirepersistante.types.beans.PhotoResourceBean;

/**
 * Describe a Picture, with a thumbnail, reference to the original file and other things.
 * <p>
 ...
 */
public class PhotoResource extends PhotoResourceBean
{

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.sporniket.libre.memoirepersistante.types.beans.PhotoResourceBean#getSelected()
	 * 
	 * @since 15.07.00-SNAPSHOT
	 */
	@Override
